...
new Vue({
  ...
  methods: {
    ...
    fetchBands: function fetchBands() {
      var _this = this;

      axios.get('http://localhost:3000/bands').then(function (_ref) {
        var data = _ref.data;
  ...
  computed: {
    bandFiltered: function bandFiltered() {
      var _this2 = this;

      var newBand = this.bands.filter(function (band) {
        return band.name.includes(_this2.search);
      });
      return newBand;
    }
  }
