...
var _default = {
  ...
  methods: {
    ...
    movePageLogin: function movePageLogin() {
              ...
              _c(
                "a",
                {
                  ...
                  on: {
                    click: function($event) {
                      $event.preventDefault()
                      return _vm.movePageLogin($event)
                    }
                  }
                },
...
},{"../config/axios":"src/config/axios.js","_css_loader":"../../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"node_modules/sweetalert2/dist/sweetalert2.all.js":[function(require,module,exports) {
var define;
var global = arguments[3];
/*!
* sweetalert2 v10.0.2
...
},{}],"src/components/CardTask.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    editTask: function editTask() {
      ...
      (0, _axios.default)({
        url: "/kanbans/".concat(this.task.id),
        method: "PUT",
        headers: {
        ...
        _this.$emit("emitEditTask", "CardCategory");
      }).catch(function (err) {
        console.log(err);
      });
      console.log({
    ...
    toHumanString: function toHumanString(date) {
...
exports.default = _default;
  ...
  return _c("div", { staticClass: "col card-body" }, [
    ...
    _vm.isEditing
      ? _c("div", { attrs: { id: "edit-form" } }, [
          ...
          _c(
            ...
            [
              _c(
                ...
                {
                  attrs: {
                    disabled: _vm.category === "backlog",
                    value: "backlog"
                  },
                  domProps: { selected: _vm.category === "backlog" }
                },
                [_vm._v("backlog")]
              ),
              _vm._v(" "),
              _c(
                "option",
                {
                  attrs: { disabled: _vm.category === "todo", value: "todo" },
                  domProps: { selected: _vm.category === "todo" }
                },
                [_vm._v("todo")]
              ),
              _vm._v(" "),
              _c(
                "option",
                {
                  attrs: { disabled: _vm.category === "doing", value: "doing" },
                  domProps: { selected: _vm.category === "doing" }
                },
                [_vm._v("doing")]
              ),
              _vm._v(" "),
              _c(
                ...
                {
                  attrs: {
                    disabled: _vm.category === "completed",
                    value: "completed"
                  },
                  domProps: { selected: _vm.category === "completed" }
                },
                [_vm._v("completed")]
              )
            ]
          ...
          _c(
            "a",
            {
              staticClass: "waves-effect waves-light btn-small green darken-1",
              on: {
                click: function($event) {
                  $event.preventDefault()
    ...
    _c("span", { staticClass: "card-subtitle mb-2 text-muted" }, [
      _vm._v("by " + _vm._s(_vm.task.User.email.split("@")[0]))
    ]),
    _vm._v(" "),
    _c("div", { staticClass: "subtitle" }, [
      _c("span", { staticClass: "card-subtitle mb-2 text-muted" }, [
        _vm._v(_vm._s(_vm.toHumanString(_vm.task.createdAt)))
      ]),
      _vm._v(" "),
...
},{"sweetalert2":"node_modules/sweetalert2/dist/sweetalert2.all.js","../config/axios":"src/config/axios.js","moment":"node_modules/moment/moment.js","_css_loader":"../../../../../../../../usr/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/CardCategory.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    addTask: function addTask() {
      ...
      (0, _axios.default)({
        ...
        _sweetalert.default.fire('Good job!', 'Successfully add task!', 'success');
        ...
        ? _c(
            ...
            [
              ...
              _vm._l(_vm.getBacklog, function(task) {
                return _c("CardTask", {
                  key: task.id,
                  attrs: { edit: _vm.edit, task: task },
                  on: {
                    emitEditTask: _vm.refreshTask,
                    emitDelete: _vm.deleteTask
                  }
                })
              })
            ],
...
var staticRenderFns = [
  function() {
    ...
    return _c("a", { staticClass: "header-icon", attrs: { href: "" } }, [
      _c("img", {
        attrs: {
          src: "https://i.imgur.com/8p3yWXz.png",
          height: "20px",
          alt: ""
        }
      })
...
var _default = {
  ...
  methods: {
    ...
    submitRegister: function submitRegister(value) {
  ...
  return _c(
    ...
    [
      ...
      _vm.currentPage === "loginPage"
        ? _c("LoginPage", {
            on: {
              emitMovePageRegister: _vm.movePageRegister,
              loginSubmit: _vm.login
            }
          })
        : _vm.currentPage === "registerPage"
        ? _c("RegisterPage", {
            on: {
              emitMovePageLogin: _vm.movePageLogin,
              emitRegister: _vm.submitRegister
            }
          })
