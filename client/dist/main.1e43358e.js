...
exports.default = _default;
        var $d77769 = exports.default || module.exports;
      
      if (typeof $d77769 === 'function') {
        $d77769 = $d77769.options;
      }
    
        /* template */
        Object.assign($d77769, (function () {
          var render = function() {
  var _vm = this
    ...
    _c("div", { staticClass: "container" }, [
      ...
      _c("div", { staticClass: "form-container" }, [
        _c("div", { staticClass: "heading" }, [
          ...
          _vm._v(" "),
          _c("h1", [_vm._v("Login into your account")])
        ]),
        _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$d77769', $d77769);
          } else {
            api.reload('$d77769', $d77769);
          }
        }
...
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/views/RegisterPage.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $fd3ee1 = exports.default || module.exports;
      
      if (typeof $fd3ee1 === 'function') {
        $fd3ee1 = $fd3ee1.options;
      }
    
        /* template */
        Object.assign($fd3ee1, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$fd3ee1', $fd3ee1);
          } else {
            api.reload('$fd3ee1', $fd3ee1);
          }
        }
...
exports.default = _default;
        var $b6a4b1 = exports.default || module.exports;
      
      if (typeof $b6a4b1 === 'function') {
        $b6a4b1 = $b6a4b1.options;
      }
    
        /* template */
        Object.assign($b6a4b1, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      _c("div", [
        _c("span", { attrs: { id: "nav-logout" } }, [
          _c(
            ...
            [_c("i", { staticClass: "fas fa-user" }), _vm._v(" Logout")]
          )
        ])
      ])
    ])
...
var staticRenderFns = [
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("div", [_c("i", { staticClass: "fas fa-home" })])
  },
  function() {
    var _vm = this
    var _h = _vm.$createElement
    ...
    return _c("div", { attrs: { id: "logo" } }, [
      _c("a", { attrs: { href: "" } }, [_vm._v("My Kanban")]),
      _vm._v(" "),
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$b6a4b1', $b6a4b1);
          } else {
            api.reload('$b6a4b1', $b6a4b1);
          }
        }
...
},{"_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/MoveOption.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  methods: {
    moveCategory: function moveCategory(taskId, categoryId) {
      ...
      (0, _axios.default)({
        url: "/tasks/".concat(taskId, "/").concat(categoryId),
        method: 'PUT',
        headers: {
        ...
        _this.$emit('successMoved');
      }).catch(function (error) {
        var notif = '';

        var _iterator = _createForOfIteratorHelper(error.response.data.errors),
            _step;
        ...
        _this.$emit('failMoved', notif);
      });
    }
  }
};
exports.default = _default;
        var $bf9821 = exports.default || module.exports;
      
      if (typeof $bf9821 === 'function') {
        $bf9821 = $bf9821.options;
      }
    
        /* template */
        Object.assign($bf9821, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$bf9821', $bf9821);
          } else {
            api.reload('$bf9821', $bf9821);
          }
        }
...
},{"../config/axios":"src/config/axios.js","_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/components/Task.vue":[function(require,module,exports) {
"use strict";
...
var _MoveOption = _interopRequireDefault(require("./MoveOption"));
...
var _default = {
  ...
  components: {
    MoveOption: _MoveOption.default
  },
  data: function data() {
    return {
      showModalEdit: false,
  ...
  methods: (_methods = {
    ...
    deleteTask: function deleteTask(taskId) {
      ...
      (0, _axios.default)({
        ...
        _this.$emit('forbiddenAccess', notif);
      });
    },
    successMoved: function successMoved() {
      this.$emit('successMoved');
      this.clearField();
    },
    openModalEdit: function openModalEdit(taskId) {
      var _this2 = this;
      ...
      (0, _axios.default)({
        ...
        var _iterator2 = _createForOfIteratorHelper(error.response.data.errors),
            _step2;
        ...
        _this2.$emit('forbiddenAccess', notif);
      });
    },
    openModalInfo: function openModalInfo(taskId) {
      var _this3 = this;
      ...
      (0, _axios.default)({
        ...
        _this3.created = data.createdAt;
        _this3.category = data.Category.name;
        _this3.user = data.User.email;
        _this3.showModalInfo = true;
      }).catch(function (error) {
        var notif = '';

        var _iterator3 = _createForOfIteratorHelper(error.response.data.errors),
            _step3;
        ...
        _this3.$emit('forbiddenAccess', notif);
      });
    },
    editTask: function editTask(taskId) {
      ...
      (0, _axios.default)({
        ...
        _this4.$emit('successEdited');
      }).catch(function (error) {
        var notif = '';

        var _iterator4 = _createForOfIteratorHelper(error.response.data.errors),
            _step4;
  ...
  }, _defineProperty(_methods, "successMoved", function successMoved() {
    this.$emit('successMoved');
  }), _defineProperty(_methods, "failMoved", function failMoved(notif) {
    this.$emit('forbiddenAccess', notif);
  }), _methods)
};
exports.default = _default;
        var $f60ce8 = exports.default || module.exports;
      
      if (typeof $f60ce8 === 'function') {
        $f60ce8 = $f60ce8.options;
      }
    
        /* template */
        Object.assign($f60ce8, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$f60ce8', $f60ce8);
          } else {
            api.reload('$f60ce8', $f60ce8);
          }
        }
...
var _default = {
  ...
  methods: {
    successDeleted: function successDeleted() {
      this.$emit('successDeleted');
    },
    forbiddenAccess: function forbiddenAccess(notif) {
      this.$emit('forbiddenAccess', notif);
    },
    successMoved: function successMoved() {
      this.$emit('successMoved');
    },
    successEdited: function successEdited() {
      this.$emit('successEdited');
    },
    failEdit: function failEdit(notif) {
                ...
                _c(
                  "button",
                  {
                    ...
                    on: {
                      click: function($event) {
                        $event.preventDefault()
                        return _vm.createNewTask(_vm.categoryId)
                      }
                    }
                  },
                  [_vm._v("Save")]
...
var _default = {
  ...
  methods: {
    currentAddFormId: function currentAddFormId(id) {
      this.addFormId = id;
    },
    clearField: function clearField() {
      this.addFormId = '';
    ...
    failCreated: function failCreated(notif) {
...
exports.default = _default;
        var $e42d63 = exports.default || module.exports;
      
      if (typeof $e42d63 === 'function') {
        $e42d63 = $e42d63.options;
      }
    
        /* template */
        Object.assign($e42d63, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    _vm._l(_vm.categories, function(category) {
      return _c("ListWraper", {
        ...
        on: {
          currentAddFormId: _vm.currentAddFormId,
          clearCurrentAddFormId: _vm.clearField,
          successCreated: _vm.successCreated,
          failCreated: _vm.failCreated,
          successDeleted: _vm.successDeleted,
          forbiddenAccess: _vm.forbiddenAccess,
          successMoved: _vm.successMoved,
          successEdited: _vm.successEdited,
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$e42d63', $e42d63);
          } else {
            api.reload('$e42d63', $e42d63);
          }
        }
...
var _default = {
  name: 'MainPage',
  props: ['categories', 'tasks', 'message'],
  components: {
...
exports.default = _default;
        var $93f6f0 = exports.default || module.exports;
      
      if (typeof $93f6f0 === 'function') {
        $93f6f0 = $93f6f0.options;
      }
    
        /* template */
        Object.assign($93f6f0, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "main",
    [
      _c("Header", { on: { logout: _vm.logout } }),
      _vm._v(" "),
      _c("div", {
        staticClass: "msg",
        domProps: { innerHTML: _vm._s(_vm.message) }
      ...
      _vm._v(" "),
      _c("Board", {
        attrs: { categories: _vm.categories, tasks: _vm.tasks },
        on: {
          successCreated: _vm.successCreated,
          failCreated: _vm.failCreated,
          successDeleted: _vm.successDeleted,
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$93f6f0', $93f6f0);
          } else {
            api.reload('$93f6f0', $93f6f0);
          }
        }
...
},{"../components/Header":"src/components/Header.vue","../components/Board":"src/components/Board.vue","_css_loader":"../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"node_modules/vue-hot-reload-api/dist/index.js","vue":"node_modules/vue/dist/vue.runtime.esm.js"}],"src/App.vue":[function(require,module,exports) {
"use strict";
  ...
  methods: {
    ...
    login: function login(user) {
      ...
      (0, _axios.default)({
        ...
        _this.message = "<p style=\"background-color: #2ed574b4;\">You've logged in successfully!</p>";
        _this.currentPage = 'main';

        _this.showAllTaskCategory();
...
exports.default = _default;
        var $4fef08 = exports.default || module.exports;
      
      if (typeof $4fef08 === 'function') {
        $4fef08 = $4fef08.options;
      }
    
        /* template */
        Object.assign($4fef08, (function () {
          var render = function() {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.currentPage === "login"
        ...
        ? _c("RegisterPage", {
            attrs: { message: _vm.message },
            on: { showLoginForm: _vm.showLoginForm, register: _vm.register }
          })
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$4fef08', $4fef08);
          } else {
            api.reload('$4fef08', $4fef08);
          }
        }
